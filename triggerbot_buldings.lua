local function triggerBot(cmd)
    ...
    local test = Vector3(localPlayer:GetPropFloat("localdata", "m_vecViewOffset[0]"), localPlayer:GetPropFloat("localdata", "m_vecViewOffset[1]"), localPlayer:GetPropFloat("localdata", "m_vecViewOffset[2]"))
    local source = localPlayer:GetAbsOrigin() + test;
